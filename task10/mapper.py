...
# reducer. However, I left the code in combiner.py in case it is a bug
# and it is fixed in a future release. In case we want to use the combiner
# we would also have to add some logic to the reducer.
