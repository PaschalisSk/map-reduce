...
COMBINER = False
task_folder = os.path.join('task8')
...
if COMBINER:
    output_file = os.path.join(task_folder, 'outputs/local_comb_job2.out')
else:
    output_file = os.path.join(task_folder, 'outputs/local_job2.out')

data_folder = os.path.join(task_folder, 'outputs')
input_files = [os.path.join(data_folder, 'local_job1.out')]
